...
export default function Contact() {
  return (
    ...
    <div className='flex'>
        <div className='flex w-1/2 rounded-tl-xl rounded-bl-xl   bg-slate-400'>
     <img src="https://zpuplawsjodqxxfqxchz.supabase.co/storage/v1/object/public/Car%20parts/Hondafit.png" style={{ marginTop: '150px' }} alt="Image" class="img-fluid"/>
        ...
        <div className='flex w-1/2 rounded-tr-xl rounded-br-xl px-4  bg-red-200'>
...
<div className='w-full ml-2 bg-transparent '>
...
<div className='w-1/2 rounded-xl mt-4 text-center bg-[#002F63] text-white px-2 py-2 '>
    Send
</div>
