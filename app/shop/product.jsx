...
export default function Product() {
  return (
    ...
    <div  className='flex flex-col mr-10 justify-end w-full'>
      <img src="https://static.vecteezy.com/system/resources/previews/036/048/444/non_2x/ai-generated-car-engine-isolated-on-a-transparent-background-ai-png.png" />
    </div>
...
<div className='border bg-gray-200 text-center h-10 w-20 items-center flex justify-center'>Model</div>
    ...
    <div  className='flex flex-col mr-10 justify-end w-full'>
      <img src="https://zpuplawsjodqxxfqxchz.supabase.co/storage/v1/object/public/Car%20parts/spares_removebg_preview.png" />
    </div>
    <div className='px-2 text-black'>
    <div className='font-bold'>
      $9000.00
